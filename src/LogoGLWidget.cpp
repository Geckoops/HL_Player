...
namespace HL
{
	LogoGLWidget::LogoGLWidget(QWidget *parent) : QOpenGLWidget(parent)
	{
	}

	void LogoGLWidget::initTextures()
	{
		// 加载 Avengers.jpg 图片
	...
	void LogoGLWidget::setImage(const QImage &image)
	{
